...
async def audio_processor(websocket: WebSocket):
    ...
    chant_counter = CountChantsFromAudioGemini()
    ...
    try:
        ...
        while True:
            ...
            chant_count = chant_counter.count_chants_gemini(reference_audio_path, audio_path)

            # Send the chant count result back to the client
            await websocket.send_text(f"Chant count result: {chant_count}")
